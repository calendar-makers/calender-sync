...
users = [{:email => 'brichard@gmail.com', :encrypted_password => '', :reset_password_token => '', :reset_password_sent_at => 'January 11 2016 12:00', :failed_attempts => 0, :level => 0, :locked_at => ''},
  ]
