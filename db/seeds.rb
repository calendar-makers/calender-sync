...
events = [{:name => 'Market Street Prototyping Festival', :organization => 'Nature in the City', 
            :description => 'A walk through the city', :venue_name => 'The Old Town Hall', 
            :st_number => 145, :st_name => 'Jackson st', :city => 'Glendale', :zip => 90210, 
            :start => 'March 09 2016 11:00', :end => 'March 19 2016, 20:30', 
            :how_to_find_us => 'First door on left', :meetup_id => 122121212, :status => 'approved'},
          {:name => 'Nerds on Safari: Market Street', :organization => 'Green Carrots', 
            :description => 'If you like beans youll like this event!', 
            :venue_name => 'San Francisco City Library', :st_number => 45, :st_name => 'Seneca st', 
