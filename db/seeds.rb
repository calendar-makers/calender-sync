...
events = [{ name: 'Gardening', organization: 'Meetup API Testing Sandbox',
            ...
            how_to_find_us: 'first door to the left', venue_name: 'The Old Town Hall', st_number: '145', st_name: 'Jackson st',
          ...
          { name: 'Green Bean Mixer',  organization: 'Meetup API Testing Sandbox',
            ...
            how_to_find_us: 'first door to the right', venue_name: 'San Francisco Library', st_number: '33', st_name: 'Seneca st',
          ...
          { name: 'Green Happiness',  organization: 'Meetup API Testing Sandbox',
            ...
            how_to_find_us: 'first door to the right', venue_name: 'San Francisco Cemetery', st_number: '115', st_name: 'Seneca st',
