...
Background:
  ...
  And the following guests exists:
...
Scenario: User sees all event attendees
  ...
  Then I should see all the info about attendees of "Nature Walk"
  And I should not see any info about attendees of "Green Bean Mixer"
